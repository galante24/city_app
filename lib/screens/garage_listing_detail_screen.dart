...
class GarageListingDetailScreen extends StatefulWidget {
  const GarageListingDetailScreen({
    super.key,
    required this.row,
  ...
  @override
  State<GarageListingDetailScreen> createState() =>
      _GarageListingDetailScreenState();
}

class _GarageListingDetailScreenState extends State<GarageListingDetailScreen> {
  bool _busy = false;
  bool? _canDelete;
  ...
  Future<void> _delete() async {
    ...
    setState(() => _busy = true);
    try {
      await GarageListingService.deleteById(_id);
      if (mounted) {
  ...
  Widget build(BuildContext context) {
    ...
    final String addr = widget.row['garage_address'] as String? ?? '';
    final String floorRaw = (widget.row['floor_area'] as String? ?? '').trim();
...
class _GarageInfoCard extends StatelessWidget {
  const _GarageInfoCard({required this.child});
