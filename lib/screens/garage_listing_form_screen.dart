...
class GarageListingFormScreen extends StatefulWidget {
  const GarageListingFormScreen({super.key});

  @override
  State<GarageListingFormScreen> createState() => _GarageListingFormScreenState();
}

class _GarageListingFormScreenState extends State<GarageListingFormScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_picked != null) {
        try {
          imageUrl = await GarageListingService.uploadGarageImage(_picked!);
        } on Object {
          // публикуем без фото
        }
      }
      await GarageListingService.insert(
        title: _title.text,
      ...
      if (kDebugMode) {
        debugPrint(
          '[GarageListingForm] PostgrestException\n'
          '  code: ${e.code}\n'
          '  message: ${e.message}\n'
          '  details: ${e.details}\n'
          '  hint: ${e.hint}',
      ...
      if (mounted) {
        if (kDebugMode) {
          debugPrint('[GarageListingForm] $e');
        }
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  TextFormField(
                    controller: _address,
                    decoration: _decoration(context, 'Адрес гаража'),
                    minLines: 1,
                    maxLines: 3,
