...
class GarageListingService {
  GarageListingService._();
  ...
  static const String _table = 'garage_listings';
  ...
  static Future<String> uploadGarageImage(XFile file) async {
    final c = _c;
    if (c == null) {
    ...
    final String ext = dot >= 0 && dot < name.length - 1
        ...
        : 'jpg';
    final String path =
        'garages/$uid/${DateTime.now().millisecondsSinceEpoch}.$ext';
  ...
  static Future<void> insert({
    ...
    await c.from(_table).insert(<String, dynamic>{
      ...
      'price': price.trim(),
      'garage_address': garageAddress.trim(),
